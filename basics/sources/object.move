module basics::object {
    ...
    /// objects, but cannot be placed in the global object pool on ist own.
    /// Note that it doesn't need an ID field.
    struct ChildObject has store {
        a_field: bool,
    }

    /// An object that can live either in the global object pool or as a nested object.
    ...
    public entry fun main(
        ...
        // ... ned objects, begin primitive type inputs
        int_input: u64,
        recipient: address,
        ctx: &mut TxContext
    ) {
